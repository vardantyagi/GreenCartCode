...
export const placeOrderCOD = async (req, res) => {
  try {
    ...
    console.log('placeOrderCOD error:', e.message);
...
export const placeOrderStripe = async (req, res) => {
  try {
    ...
    console.log('placeOrderStripe error:', e.message);
    return res.json({ success: false, message: e.message });
  }
}
...
export const getUserOrders = async (req, res) => {
  try {
    ...
    console.log('getUserOrders error:', e.message);
    return res.json({ success: false, message: e.message });
  }
}

// gt all orders ( for seller / admin ): /api/order/seller
export const getAllOrders = async (req, res) => {
  try {
    ...
    console.log('getAllOrders error:', e.message);
    return res.json({ success: false, message: e.message });
  }
}
